 ...
 * @returns Styled text
 */
export function convertByTone(text, tone) {
    const styleMap = {
        happy: 'normal',
        sad: 'small_caps',
        angry: 'bold',
 ...
 */
export function containsStyledUnicode(text) {
 ...
 */
export function convertEmphasizedWords(text, tone, emphasizedWords) {
 ...
 */
export function convertKeywordsByTone(text, tone) {
...
//# sourceMappingURL=unicodeConverter.js.map